...
import { Header, Input, Button, Icon , formatVnd } from "../components/Components";
...
export default function CheckoutScreen() {
  ...
  const { cart, placeOrder, adminSettings, user } = useApp();
  ...
  const hasProfileAddress = Boolean(
    ...
    user?.name && user?.phone && savedAddress?.address && savedAddress?.city
  ...
  const savedAddressText = useMemo(() => {
    ...
    return [savedAddress.address, savedAddress.ward, savedAddress.district, savedAddress.city]
  ...
  }, [hasProfileAddress, savedAddress?.address, savedAddress?.city, user?.name, user?.phone]);
  ...
  const validate = () => {
    ...
    if (!hasProfileAddress) {
      ...
      if (!fullName.trim()) nextErrors.fullName = "Vui lòng nhập h tên";
  ...
  const handleOrder = () => {
    ...
    const shippingAddress = hasProfileAddress

      ? savedAddressText

      : `${address}, ${city} ${zip}`.trim();
    ...
    const orderData = {
      ...
      phone: hasProfileAddress ? user?.phone || "" : phone,
    ...
    <div className="flex flex-col h-full bg-background-light dark:bg-background-dark">
      ...
      <main className="flex-1 overflow-y-auto px-4 pb-32">
        ...
        {hasProfileAddress ? (
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1e1e2d] p-4 mb-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">{savedAddressText}</p>
            ...
            <p className="text-xs text-gray-400 mt-3">
              ...
              Saved address from profile. No need to re-enter.
          ...
          <div className="space-y-4">
            ...
            <label className="block">
              ...
              <Input
                ...
                placeholder="Nhập h tên của bạn"
        ...
        <div className="bg-white dark:bg-[#1e1e2d] rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="p-4 flex flex-col gap-2 bg-gray-50 dark:bg-white/5">
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="text-gray-500 text-sm">Tổng tin</p>
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="text-primary text-lg font-bold">{formatVnd(total)}</p>
