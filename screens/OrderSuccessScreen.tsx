...
export default function OrderSuccessScreen() {
  ...
  const safeOrderId = orderId || "#ORD-0000";
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-[#121121]">
       ...
       <main className="flex-1 overflow-y-auto px-6 pb-24 flex flex-col items-center text-center">
          ...
          <h1 className="text-slate-900 dark:text-white text-[28px] font-bold leading-tight mb-3">
            Đặt hàng thành công!
          </h1>
          <p className="text-gray-500 dark:text-gray-400 text-base mb-8">
            Cám ơn bạn đã mua hàng. Đơn hàng của bạn đang được xử lý.
          </p>
          ...
          <div className="bg-gray-50 dark:bg-white/5 rounded-2xl p-5 mb-8 w-full text-left">
             <div className="flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700/50">
                 ...
                 <p className="text-slate-900 dark:text-white text-sm font-semibold">{safeOrderId}</p>
             </div>
             <div className="flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700/50">
                 <div className="flex items-center gap-3">
                     <div className="w-8 h-8 rounded-full bg-white dark:bg-white/10 flex items-center justify-center text-gray-400">
       ...
       <div className="p-6 border-t border-gray-100 dark:border-gray-800">
           <Button className="w-full mb-3" onClick={() => navigate('/')}>
             Tiếp tục mua sắm
           </Button>
           <Button variant="ghost" className="w-full" onClick={() => navigate('/order-history')}>
             Theo dõi đơn hàng
           </Button>
       </div>
    </div>
